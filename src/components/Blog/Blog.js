  ...
  return (
    <div>
      <div className="container blog-container mt-5">
          ...
          <h3 className="blog-text">From Our Blog <hr /> </h3>
        ...
        <Row xs={1} md={3} className="g-4 mt-3">
          <Col>
            <Card>
              ...
              <Card.Body>
                <Card.Title>Importent tips for your faviorate car.Best informative way to learn</Card.Title>
                <div className="d-flex justify-content-around">
                    <img className="blog-img" src={bloger} alt="" />
                    <small>By Nabila Nur </small> <small>|</small> <small>Feb 01,2022</small>
                </div>
              </Card.Body>
            </Card>
          </Col>
          <Col>
            <Card>
              ...
              <Card.Body>
                <Card.Title>Does the Brand of Gas I Use Actually Matter?</Card.Title>
                <div className="d-flex justify-content-around">
                    <img className="blog-img" src={bloger} alt="" />
                    <small>By Nabila Nur</small> <small>|</small> <small>Feb 01,2022</small>
                </div>
